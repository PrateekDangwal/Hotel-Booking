...
const RommDetails = () => {
  ...
  return (
    <div className="py-28 md:py-36 px-4 md:px-16 lg:px-24 xl:px-32">
      ...
      <div className="flex flex-col md:flex-row md:items-center gap-3">
        ...
        <p className="text-xs text-white bg-orange-500 px-3 py-1 rounded-full">
          20% OFF
        </p>
      </div>
        ...
        <div className="lg:w-1/2 grid grid-cols-2 gap-4">
          {room.images.slice(1).map((image, index) => (
            <img
              ...
              className={`w-full h-48 object-cover rounded-xl shadow-md cursor-pointer transition-all duration-200 ${
                mainImage === image
 ...
 <div className="w-px h-15 bg-gray-300/70 max-md:hidden" ></div>
                ...
                <div className="flex flex-col">
                    <label htmlFor="checkInDate" className="font-medium">Guests</label>
...
<div className='mt-25 space-y-4'>
  ...
  <p>
    ...
    allocated on the ground floor according to availability. You get the
